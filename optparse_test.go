...
type test struct {
	where    string
	setup    func(o *optparse.OptionParser, t *test)
	args     []string
	expected interface{}
	err      error
	result   interface{}
...
var tests = []test{
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.Bool("bool", 'b', false) },
		args:     []string{"-b"},
		expected: true,
	},
	{
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.Int("int", 'i', 0) },
		args:     []string{"-i", "-31337"},
		expected: -31337,
	},
	{
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.Uint("uint", 'u', 0) },
		args:     []string{"-u", "31337"},
		expected: uint(31337),
	},
	{
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.Float("float", 'f', 0.0) },
		args:     []string{"-f3.1337"},
		expected: 3.1337,
	},
	{
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.String("string", 's', "") },
		args:     []string{"-sfoo"},
		expected: "foo",
	},
	{
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.BoolList("bool", 'b') },
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.IntList("int", 'i') },
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.UintList("uint", 'u') },
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.FloatList("float", 'f') },
	...
	{
		where:    here(),
		setup:    func(o *optparse.OptionParser, tt *test) { tt.result = o.StringList("string", 's') },
	...
	{
		where: here(),
		setup: func(o *optparse.OptionParser, tt *test) { tt.result = o.Bool("int", 'i', false) },
		args:  []string{"--int=not-int"},
		err:   errors.New("invalid value `not-int' for option `--int'"),
	},
	{
		where: here(),
		setup: func(o *optparse.OptionParser, tt *test) { tt.result = o.Bool("uint", 'f', false) },
		args:  []string{"--uint=not-uint"},
		err:   errors.New("invalid value `not-uint' for option `--uint'"),
	},
	{
		where: here(),
		setup: func(o *optparse.OptionParser, tt *test) { tt.result = o.Bool("float", 'f', false) },
